...
#[cfg(feature = "gce")]
const_trait! {
    /// Marker trait for bitfields that can be used as read-only nested bitfields.
...
#[cfg(feature = "gce")]
const_trait! {
    /// Marker trait for bitfields that can be used as readable and writable nested bitfields.
    #[cfg_attr(all(doc, feature = "nightly"), doc(cfg(feature = "gce")))]
...
#[cfg(feature = "gce")]
const_trait! {
    /// Marker trait for bitfields that can be used as write-only nested bitfields.
    #[cfg_attr(all(doc, feature = "nightly"), doc(cfg(feature = "gce")))]
